...
val goodLight = Color(0xFF39693B)
val onGoodLight = Color(0xFFFFFFFF)
val goodContainerLight = Color(0xFFBAF0B7)
val onGoodContainerLight = Color(0xFF002106)
val middleLight = Color(0xFF6C5E10)
val onMiddleLight = Color(0xFFFFFFFF)
val middleContainerLight = Color(0xFFF6E388)
val onMiddleContainerLight = Color(0xFF211B00)

val goodLightMediumContrast = Color(0xFF1C4C22)
val onGoodLightMediumContrast = Color(0xFFFFFFFF)
val goodContainerLightMediumContrast = Color(0xFF4F8050)
val onGoodContainerLightMediumContrast = Color(0xFFFFFFFF)
val middleLightMediumContrast = Color(0xFF4E4300)
val onMiddleLightMediumContrast = Color(0xFFFFFFFF)
val middleContainerLightMediumContrast = Color(0xFF837526)
val onMiddleContainerLightMediumContrast = Color(0xFFFFFFFF)

val goodLightHighContrast = Color(0xFF002909)
val onGoodLightHighContrast = Color(0xFFFFFFFF)
val goodContainerLightHighContrast = Color(0xFF1C4C22)
val onGoodContainerLightHighContrast = Color(0xFFFFFFFF)
val middleLightHighContrast = Color(0xFF292200)
val onMiddleLightHighContrast = Color(0xFFFFFFFF)
val middleContainerLightHighContrast = Color(0xFF4E4300)
val onMiddleContainerLightHighContrast = Color(0xFFFFFFFF)

val goodDark = Color(0xFF9FD49C)
val onGoodDark = Color(0xFF053911)
val goodContainerDark = Color(0xFF205026)
val onGoodContainerDark = Color(0xFFBAF0B7)
val middleDark = Color(0xFFD9C76F)
val onMiddleDark = Color(0xFF393000)
val middleContainerDark = Color(0xFF524700)
val onMiddleContainerDark = Color(0xFFF6E388)

val goodDarkMediumContrast = Color(0xFFA3D8A0)
val onGoodDarkMediumContrast = Color(0xFF001B04)
val goodContainerDarkMediumContrast = Color(0xFF6A9D6A)
val onGoodContainerDarkMediumContrast = Color(0xFF000000)
val middleDarkMediumContrast = Color(0xFFDECB73)
val onMiddleDarkMediumContrast = Color(0xFF1B1600)
val middleContainerDarkMediumContrast = Color(0xFFA19140)
val onMiddleContainerDarkMediumContrast = Color(0xFF000000)

val goodDarkHighContrast = Color(0xFFF0FFEB)
val onGoodDarkHighContrast = Color(0xFF000000)
val goodContainerDarkHighContrast = Color(0xFFA3D8A0)
val onGoodContainerDarkHighContrast = Color(0xFF000000)
val middleDarkHighContrast = Color(0xFFFFFAF4)
val onMiddleDarkHighContrast = Color(0xFF000000)
val middleContainerDarkHighContrast = Color(0xFFDECB73)
val onMiddleContainerDarkHighContrast = Color(0xFF000000)
